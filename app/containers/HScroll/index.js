...
class HScroll extends Component {
  ...
  moveRight(e) {
    ...
    if (this.hScrollElement.scrollLeft > 0) {
      smoothScroll(
        this.hScrollElement,
        this.hScrollElement.scrollLeft - this.props.scrollWidth,
        0
      );
    }
    this.displyNextPrevButton();
  ...
  moveLeft(e) {
    e.preventDefault();
    const maxScrollLeft =
      this.hScrollElement.scrollWidth - this.hScrollElement.clientWidth;
        ...
        {this.props.inline && (
          <div>
            <SliderWrapper
              ...
              style={{ left: 0 }}
              disabled={this.state.pButtonDisabled}
              ref="prevButton"
            >
              <NavigationLeft />
            </SliderWrapper>
            <SliderWrapper
              ...
              style={{ right: 0 }}
              disabled={this.state.nButtonDisabled}
              ref="nextButton"
            >
              <NavigationRight />
            </SliderWrapper>
